...
app.get('/lib/js/highlight.js', function(req, res) {
    res.sendFile(__dirname + '/node_modules/highlightjs/highlight.pack.js');
});

app.get('/lib/css/atom-one-light.css', function(req, res) {
    res.sendFile(__dirname + '/node_modules/highlightjs/styles/atom-one-light.css');
});
